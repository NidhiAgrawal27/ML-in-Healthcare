...
from visualization import lime
...
CONFIG = {"log_dir": "../logs/", "model_name": "baseline_cnn_lime", "es_patience": 10,
          "max_epochs": 50, "batch_size": 64, "train_hparams": {"lr": 0.001, "lr_patience": 5}, "figure_dir": "../logs/figures/lime/"}
...
def main():
    ...
    # create lime explanations and save
    for i, (x, y) in enumerate(test_dataset):
        pred, np_lime_img = lime.get_lime_explanation(model=model, image=x)
        fname = os.path.join(
            CONFIG["figure_dir"], "{}__pred_{}__label_{}.png".format(i, pred, y))
        lime.save_lime(np_lime_img, fname)
